...
describe( 'partial quantile', function tests() {
	...
	it( 'should partially apply the quantile function of the Negative Binomial distribution for given parameter values', function test() {
		var quantile;
		quantile = partial( r, p );
