...
describe( 'accessor quantile', function tests() {
	...
	it( 'should evaluate the quantile function of the Negative Binomial distribution using an accessor', function test() {
		...
		actual = quantile( actual, data, r, p,getValue );
